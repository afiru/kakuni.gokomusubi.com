...
<body id="body" <?php body_class('baseBody'); ?>>
  <div id="pageTop" class="wap">
    <header id="scroll_off" class="base_header">
      <div class="pc_only"><?php get_template_part('include/common/header/01_headerPc'); ?></div>
      <div class="sp_only"><?php get_template_part('include/common/header/02_headerSp'); ?></div>
    </header>